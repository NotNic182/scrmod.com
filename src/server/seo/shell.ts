  ...
  switch (data.kind) {
    ...
    case 'about':
      ...
      main =
        ...
        `<ul class="prose"><li><strong>Appear offline</strong> in the game (F5 → Settings) removes you from the online lists here too.</li><li><strong>Hide gold</strong> in the game hides your gold here as well.</li><li>Your Discord name appears only if you switched on <strong>Show Discord</strong> in the game.</li><li>Deleting your data in the game removes it here within a minute.</li><li>The live stream player comes from Twitch or YouTube and only loads when you press play.</li><li>Search engines may keep an older copy of a public page for a while after data changes. Player profile pages ask search engines not to index them.</li></ul>` +
        `</section>` +
